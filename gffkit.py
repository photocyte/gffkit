...
################################
    ...
    def add_parent_features(self):
        ...
        requiredNamed.add_argument("--no_add_back_parent_attr",action='store_true',help="A switch to turn off the behavior of adding back the Parent= attribute (needed to repair from the flo pipeline)",required=False)
